...
class Header extends Component {
    ...
    loginClickHandler = () => {
        ...
        xhrLogin.addEventListener("readystatechange",function(){
            if(this.readyState === 4) {
                console.log(xhrLogin.getResponseHeader('acces-token'));
    ...
    registerClickHandler = () =>{
        ...
        this.state.passwordReg === "" ? this.setState({passwordRequired:"dispBlock"}):this.setState({passwordRequired:"dispNone"});
            ...
            <div>
                <header className = "app-header">
                    ...
                    <div className="login-button">
                        <Button variant="container" color="default" onClick={this.openModalHandler}>Login</Button>
                        </div>
                        :
                        <div className = "login-button">
                        ...
                        <div className = "bookshow-button">
                            <Button variant = "contained" onClick={this.openModalHandler} color="primary">BOOK SHOW</Button>
                            </div> : ""}

                        {this.props.showBookShowButton === "true" && this.state.loggedIn ?
                         <div className = "bookshow-button">
                             <link to={"/bookshow/" + this.props.id}><Button variant = "contained" color="primary">BOOK SHOW</Button></link>
